...
func containerlabLabName(scopeSlug, deploymentName string) string {
	...
	return fmt.Sprintf("%s-%s", scopeSlug, deploymentName)
}
...
func containerlabAPIURL(cfg skyforgecore.Config, server NetlabServerConfig) string {
...
func containerlabSkipTLS(cfg skyforgecore.Config, server NetlabServerConfig) bool {
