...
func createTask(ctx context.Context, db *sql.DB, userScopeID string, deploymentID *string, taskType string, message string, createdBy string, metadata JSONMap) (*TaskRecord, error) {
	return taskstore.CreateTask(ctx, db, userScopeID, deploymentID, taskType, message, createdBy, metadata)
}
...
func createTaskAllowActive(ctx context.Context, db *sql.DB, userScopeID string, deploymentID *string, taskType string, message string, createdBy string, metadata JSONMap) (*TaskRecord, error) {
	return taskstore.CreateTaskAllowActive(ctx, db, userScopeID, deploymentID, taskType, message, createdBy, metadata)
}
...
func findActiveTaskByDedupeKey(ctx context.Context, db *sql.DB, userScopeID string, deploymentID *string, taskType string, dedupeKey string) (*TaskRecord, error) {
	return taskstore.FindActiveTaskByDedupeKey(ctx, db, userScopeID, deploymentID, taskType, dedupeKey)
}

func hasActiveDeploymentTask(ctx context.Context, db *sql.DB, userScopeID string, deploymentID string) (bool, error) {
	return taskstore.HasActiveDeploymentTask(ctx, db, userScopeID, deploymentID)
}

func getActiveDeploymentTask(ctx context.Context, db *sql.DB, userScopeID string, deploymentID string) (*TaskRecord, error) {
	return taskstore.GetActiveDeploymentTask(ctx, db, userScopeID, deploymentID)
}

func getOldestQueuedDeploymentTaskID(ctx context.Context, db *sql.DB, userScopeID string, deploymentID string) (int, error) {
...
func getDeploymentQueueSummary(ctx context.Context, db *sql.DB, userScopeID string, deploymentID string) (*deploymentQueueSummary, error) {
	return taskstore.GetDeploymentQueueSummary(ctx, db, userScopeID, deploymentID)
}
...
func listTasks(ctx context.Context, db *sql.DB, userScopeID string, limit int) ([]TaskRecord, error) {
	return taskstore.ListTasks(ctx, db, userScopeID, limit)
}
...
func getLatestDeploymentTask(ctx context.Context, db *sql.DB, userScopeID string, deploymentID string, taskType string) (*TaskRecord, error) {
	return taskstore.GetLatestDeploymentTask(ctx, db, userScopeID, deploymentID, taskType)
}
