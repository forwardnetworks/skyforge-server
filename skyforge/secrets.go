...
var secrets struct {
	...
	SKYFORGE_OBJECT_STORAGE_TERRAFORM_ACCESS_KEY string `secret:"SKYFORGE_OBJECT_STORAGE_TERRAFORM_ACCESS_KEY"`
	SKYFORGE_OBJECT_STORAGE_TERRAFORM_SECRET_KEY string `secret:"SKYFORGE_OBJECT_STORAGE_TERRAFORM_SECRET_KEY"`
...
func getSecrets() skyforgecore.Secrets {
	return skyforgecore.Secrets{
		...
		ObjectStorageTerraformAccessKey: secrets.SKYFORGE_OBJECT_STORAGE_TERRAFORM_ACCESS_KEY,
		ObjectStorageTerraformSecretKey: secrets.SKYFORGE_OBJECT_STORAGE_TERRAFORM_SECRET_KEY,
