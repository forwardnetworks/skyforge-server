...
// PostUserForwardNetworkCapacityPathBottlenecks uses Forward's /paths-bulk API and projects results into a capacity-only
...
func (s *Service) PostUserForwardNetworkCapacityPathBottlenecks(ctx context.Context, id, networkRef string, req *ForwardNetworkCapacityPathBottlenecksRequest) (*ForwardNetworkCapacityPathBottlenecksResponse, error) {
	...
	return capacityPathBottlenecksFromFwdOut(ctx, client, pc.context.ID, net.ID, net.ForwardNetworkID, window, windowDays, req, join, asOf, fwdOut, true)
}
