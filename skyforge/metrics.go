...
var (
	...
	userScopeSyncManualRequests = metrics.NewCounter[uint64]("skyforge_user_scope_sync_manual_requests_total", metrics.CounterConfig{})
	userScopeSyncAdminRequests  = metrics.NewCounter[uint64]("skyforge_user_scope_sync_admin_requests_total", metrics.CounterConfig{})
	userScopeSyncFailures       = metrics.NewCounter[uint64]("skyforge_user_scope_sync_failures_total", metrics.CounterConfig{})
	userScopeSyncErrors         = metrics.NewCounter[uint64]("skyforge_user_scope_sync_errors_total", metrics.CounterConfig{})
	userScopeSyncBackgroundRuns = metrics.NewCounter[uint64]("skyforge_user_scope_sync_background_runs_total", metrics.CounterConfig{})
)
