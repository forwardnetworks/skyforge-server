...
type UserScopeContainerlabTemplateRequest struct {
...
type UserScopeContainerlabTemplateResponse struct {
...
// GetUserScopeContainerlabTemplate reads a containerlab YAML template from a user-scope/blueprints/external repo.
//
...
func (s *Service) GetUserScopeContainerlabTemplate(ctx context.Context, id string, req *UserScopeContainerlabTemplateRequest) (*UserScopeContainerlabTemplateResponse, error) {
	...
	return &UserScopeContainerlabTemplateResponse{
