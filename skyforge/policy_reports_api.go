...
func (s *Service) policyReportsForwardClient(ctx context.Context, ownerID, username, forwardNetworkID string) (*forwardClient, error) {
	if s == nil || s.db == nil {
		return nil, errs.B().Code(errs.Unavailable).Msg("server unavailable").Err()
	}

	rec, err := resolveForwardCredentialsFor(ctx, s.db, s.cfg.SessionSecret, ownerID, username, forwardNetworkID, forwardCredResolveOpts{})
	if err != nil {
		return nil, err
	}
...
func (s *Service) GetUserPolicyReportCatalog(ctx context.Context, id string) (*PolicyReportCatalog, error) {
...
func (s *Service) GetUserPolicyReportPacks(ctx context.Context, id string) (*PolicyReportPacks, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
func (s *Service) GetUserPolicyReportChecks(ctx context.Context, id string) (*PolicyReportChecksResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
func (s *Service) GetUserPolicyReportCheck(ctx context.Context, id string, checkId string) (*PolicyReportCheckResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
func (s *Service) GetUserPolicyReportSnapshots(ctx context.Context, id string, req *PolicyReportSnapshotsRequest) (*PolicyReportSnapshotsResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
	...
	client, err := s.policyReportsForwardClient(ctx, pc.context.ID, pc.claims.Username, strings.TrimSpace(req.NetworkID))
	if err != nil {
		return nil, err
	}
...
func (s *Service) RunUserPolicyReportNQE(ctx context.Context, id string, req *PolicyReportNQERequest) (*PolicyReportNQEResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
// RunUserPolicyReportCheck executes an embedded check (.nqe) and returns a normalized response.
func (s *Service) RunUserPolicyReportCheck(ctx context.Context, id string, req *PolicyReportRunCheckRequest) (*PolicyReportNQEResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
// RunUserPolicyReportPack executes all checks in a pack (serially) and returns per-check results.
func (s *Service) RunUserPolicyReportPack(ctx context.Context, id string, req *PolicyReportRunPackRequest) (*PolicyReportRunPackResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
...
// RunUserPolicyReportPackDelta runs a pack on two snapshots and returns a per-check delta summary.
func (s *Service) RunUserPolicyReportPackDelta(ctx context.Context, id string, req *PolicyReportPackDeltaRequest) (*PolicyReportPackDeltaResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
	...
	// Run the pack twice.
	baseResp, err := s.RunUserPolicyReportPack(ctx, id, &PolicyReportRunPackRequest{
		NetworkID:    networkID,
		SnapshotID:   baseSnap,
		PackID:       packID,
	...
	compResp, err := s.RunUserPolicyReportPack(ctx, id, &PolicyReportRunPackRequest{
		NetworkID:    networkID,
		SnapshotID:   compSnap,
		PackID:       packID,
		QueryOptions: req.QueryOptions,
