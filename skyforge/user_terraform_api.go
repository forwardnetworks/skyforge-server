...
// GetWorkspaceTerraformTemplates lists Terraform template directories for a user context.
//
//encore:api auth method=GET path=/api/user-contexts/:id/terraform/templates
