...
type UserScopeContainerlabTemplatesResponse struct {
...
type UserScopeContainerlabTemplatesRequest struct {
...
func (s *Service) GetUserScopeContainerlabTemplates(ctx context.Context, id string, req *UserScopeContainerlabTemplatesRequest) (*UserScopeContainerlabTemplatesResponse, error) {
	...
	_ = ctx
	return &UserScopeContainerlabTemplatesResponse{
