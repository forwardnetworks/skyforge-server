...
type UserScopeNetlabTemplateRequest struct {
...
type UserScopeNetlabTemplateResponse struct {
...
// GetUserScopeNetlabTemplate reads a netlab YAML template from a user-scope/blueprints/external repo.
//
// This powers "View template" in the deployment creation flow.
//
//encore:api auth method=GET path=/api/users/:id/netlab/template
func (s *Service) GetUserScopeNetlabTemplate(ctx context.Context, id string, req *UserScopeNetlabTemplateRequest) (*UserScopeNetlabTemplateResponse, error) {
	...
	return &UserScopeNetlabTemplateResponse{
