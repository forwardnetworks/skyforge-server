...
// systemWorkspaceContext returns a workspaceContext without enforcing user RBAC.
...
func (s *Service) systemWorkspaceContext(ctx context.Context, workspaceKey string, username string) (*workspaceContext, error) {
	_ = ctx
	if s == nil {
