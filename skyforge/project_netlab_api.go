...
//
//encore:api auth method=GET path=/api/projects/:id/netlab/templates
...
// GetProjectNetlabTemplatesV1 lists Netlab templates for a project (v1 alias).
//
//encore:api auth method=GET path=/api/v1/projects/:id/netlab/templates
func (s *Service) GetProjectNetlabTemplatesV1(ctx context.Context, id string) (*ProjectNetlabTemplatesResponse, error) {
	return s.GetProjectNetlabTemplates(ctx, id, nil)
}
