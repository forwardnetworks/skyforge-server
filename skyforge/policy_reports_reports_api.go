...
// GetUserContextPolicyReportRunReport renders a stored run into an auditor-friendly report.
//
//encore:api auth method=GET path=/api/user-contexts/:id/policy-reports/runs/:runId/report
func (s *Service) GetUserContextPolicyReportRunReport(ctx context.Context, id string, runId string, req *PolicyReportRunReportRequest) (*PolicyReportRunReportResponse, error) {
	...
	findings, err := listPolicyReportRunFindings(ctx, s.db, pc.userContext.ID, runId, "", limit)
