...
// PostUserContextPolicyReportPathsEnforcementBypass evaluates a set of flows and returns
...
//
//encore:api auth method=POST path=/api/user-contexts/:id/policy-reports/paths/enforcement-bypass
func (s *Service) PostUserContextPolicyReportPathsEnforcementBypass(ctx context.Context, id string, req *PolicyReportPathsEnforcementBypassRequest) (*PolicyReportNQEResponse, error) {
...
// PostUserContextPolicyReportPathsEnforcementBypassStore runs Paths Assurance and persists it as a Policy Report run.
//
...
//
//encore:api auth method=POST path=/api/user-contexts/:id/policy-reports/paths/enforcement-bypass/store
func (s *Service) PostUserContextPolicyReportPathsEnforcementBypassStore(ctx context.Context, id string, req *PolicyReportPathsEnforcementBypassStoreRequest) (*PolicyReportPathsEnforcementBypassStoreResponse, error) {
	user, err := requireAuthUser()
	if err != nil {
		return nil, err
	}
