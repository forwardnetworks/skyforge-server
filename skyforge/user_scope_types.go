...
// UserScope is the user-facing user-scope object stored in Postgres and returned by the API.
//
...
type UserScope struct {
	...
	// EVE-NG deployments require an endpoint. This flag enables configuring a per-user-scope EVE server.
