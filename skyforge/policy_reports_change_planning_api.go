...
// SimulateUserPolicyReportChangePlanning simulates a rule change against a set of flows (no config push).
func (s *Service) SimulateUserPolicyReportChangePlanning(ctx context.Context, id string, req *PolicyReportChangePlanningRequest) (*PolicyReportChangePlanningResponse, error) {
