...
func main() {
	var (
		baseURL       = flag.String("url", strings.TrimSpace(os.Getenv("SKYFORGE_MCP_URL")), "Skyforge MCP endpoint URL (e.g. https://host/api/mcp/rpc or /api/user-contexts/<id>/mcp/forward/<net>/rpc)")
